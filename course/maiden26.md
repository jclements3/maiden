...
- [ ] Start `software/maiden/validate.py` with
...
- [ ] Only validity-flagged epochs enter the residual set.
- [ ] **Zero-noise identity test**: twin with all noise off, fused track
      replaced by truth-resampled-to-epochs → every RMS ~0, continuity
      1.0. This catches sign and interpolation bugs first.
- [ ] **Alignment tripwire test**: copy a twin session, shift one
